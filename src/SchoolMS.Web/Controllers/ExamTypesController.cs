...
public class ExamTypesController : Controller
{
    ...
    public ExamTypesController(IExamTypeService service, IPlatformService platformService, IOneSignalNotificationService pushService)
    {
        _service = service;
    ...
    public async Task<IActionResult> Create(ExamTypeDto dto)
    {
        ...
        await _pushService.SendToPersonTypesAsync("New Exam Type", $"{dto.TypeName} has been added", new[] { "Teacher" }, dto.SchoolId);
