...
public class HrDepartmentsController : Controller
{
    ...
    public HrDepartmentsController(IHrDepartmentService service, IBranchService branchService, IPlatformService platformService, IOneSignalNotificationService pushService)
    {
        _service = service;
