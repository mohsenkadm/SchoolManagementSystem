...
public class HrDisciplinaryController : Controller
{
    ...
    public HrDisciplinaryController(IHrDisciplinaryService service, IHrEmployeeService empService, IOneSignalNotificationService pushService)
    ...
    public async Task<IActionResult> Index(int? employeeId) => View(await _service.GetAllAsync(employeeId));
