...
public class HrLeavesController : Controller
{
    ...
    public HrLeavesController(IHrLeaveService service, IHrEmployeeService empService, IOneSignalNotificationService pushService)
    ...
    public async Task<IActionResult> Index(HrLeaveStatus? status) => View(await _service.GetAllRequestsAsync(status));
